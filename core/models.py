...
class Funcionario(Base):
    ...
    imagem = StdImageField('Imagem', upload_to=get_file_path, variations = {'tumb': {'width': 480, 'height': 480, 'crop': True}})
    facebook = models.CharField('Facebook', max_length = 100, default = '#')
    twitter = models.CharField('Twitter', max_length = 100, default = '#')
    isntagram = models.CharField('Instagram', max_length = 100, default = '#')
...
class Recurso(Base):
    ICONE_CHOICES = (
        ('lni-rocket', 'foguete'),
        ('lni-laptop-phone', 'telefone-leptop'),
        ('lni-cog', 'engrenagem'),
        ('lni-leaf', 'folha'),
        ('lni-layers', 'design'),
    )
